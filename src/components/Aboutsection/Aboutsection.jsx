      ...
      >
        ...
        <div className="services-section">
          <div className="section-title-ctn ">
            ...
            <p style={{ color: "black", marginTop: 15, marginBottom: 15,textAlign:'center', }}>
          ...
          <div className="services-left-ctn row">
            <div className="col-three-width  animate__animated animate__backInLeft animate__slow ">
            ...
            <div className="col-three-width">
              <div className=" services-details-main">
                <div className="services-details-ctn">
            ...
            <div className="col-three-width -margin-top">
              <div className="services-details-main">
                ...
                <div className="services-details-ctn services-details-ctn-last animate__animated animate__slideInUp animate__slower">
                  <div className="services-details-last">
                    <h3> Resilient </h3>
                    <p>
                      He has demonstrated resilience and perseverance in the
                      face of challenges to a build successful businesses.
                    </p>
                  </div>
                </div>
              </div>
